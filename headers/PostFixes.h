class PostFixes {
 ...
 public:
  ...
  std::vector<std::string> dynamic2;
...
/*   std::vector<std::string> Rog; */
 ...
 private:
  void build_() {
    ...
    dynamic2.push_back("_eff");
    dynamic2.push_back("_dist");
    dynamic2.push_back("_charge");
    dynamic2.push_back("_normch");
    dynamic2.push_back("_pixch");
